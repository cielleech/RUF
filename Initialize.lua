...
local versionFromToc = C_AddOns.GetAddOnMetadata('RUF','Version')
local versionFromPackager = "262.2.4"
local isDev = false
...
function RUF:OnInitialize()
	...
	--project-revision
	RUF.db.global.Version = C_AddOns.GetAddOnMetadata('RUF','Version')
