...
--[[   	local name, icon, count, debuffType, duration, expiration, caster, isStealable,
	...
	if (aura) then
		local name, texture, count, debuffType, duration, expiration, caster, isStealable,
			nameplateShowSelf, spellID, canApply, isBossDebuff, casterIsPlayer, nameplateShowAll,
			timeMod = aura.name, aura.icon, aura.applications, aura.dispelName, aura.duration, aura.expirationTime,
		...
		local effect1, effect2, effect3 = unpack(aura.points)
